...
## [0.47.0](https://github.com/nickderobertis/onepipeline/compare/v0.46.0...v0.47.0) - 2026-09-26

### Added

- *(config)* per-node and live node-scope graph overrides ([#495](https://github.com/nickderobertis/onepipeline/pull/495))
...
- *(sdk)* give every post-launch verb a typed library call and group runs by project ([#402](https://github.com/nickderobertis/onepipeline/pull/402))

## [0.38.2](https://github.com/nickderobertis/onepipeline/compare/v0.38.1...v0.38.2) - 2026-09-20

### Fixed

- *(deps)* relink the fixed onevcs and oneharness-core, settle a host-prerequisite refusal without redispatch ([#394](https://github.com/nickderobertis/onepipeline/pull/394))
...
- *(channel)* [**breaking**] name no observer member in the engine: edit-applied, resettable check-in, the detailed profile ([#350](https://github.com/nickderobertis/onepipeline/pull/350))
...
- *(deps)* relink oneharness-core for the Claude login-refusal classifier ([#314](https://github.com/nickderobertis/onepipeline/pull/314))
- *(hooks)* give run-end hook idempotency a retry epoch ([#311](https://github.com/nickderobertis/onepipeline/pull/311))
...
- *(writeback)* write a launched run's work queued before dispatch, and carry delivers ([#301](https://github.com/nickderobertis/onepipeline/pull/301))
...
- *(writeback)* report a store that is gone at once instead of waiting out its floor ([#262](https://github.com/nickderobertis/onepipeline/pull/262))
...
- *(dispatch)* tell a manager note from a supervisor turn, and carry one across a re-dispatch ([#231](https://github.com/nickderobertis/onepipeline/pull/231))

### Fixed

- *(unwatched)* prove a driven run settled from its own record, and name a document behind its journal as undecided ([#232](https://github.com/nickderobertis/onepipeline/pull/232))
...
- serve run listings from the summary document and report which owned runs nothing watches ([#225](https://github.com/nickderobertis/onepipeline/pull/225))

## [0.26.1](https://github.com/nickderobertis/onepipeline/compare/v0.26.0...v0.26.1) - 2026-09-10

### Fixed

- *(driver)* guarantee a handed-off edit is applied, and date the surface it hands out ([#223](https://github.com/nickderobertis/onepipeline/pull/223))

## [0.26.0](https://github.com/nickderobertis/onepipeline/compare/v0.25.0...v0.26.0) - 2026-09-09

### Fixed

- *(engine)* apply a command envelope whole, and make the records it writes say what they mean ([#221](https://github.com/nickderobertis/onepipeline/pull/221))
...
- *(channel)* keep a blocking question answerable while its asker re-arms ([#204](https://github.com/nickderobertis/onepipeline/pull/204))

## [0.22.1](https://github.com/nickderobertis/onepipeline/compare/v0.22.0...v0.22.1) - 2026-09-05

### Added

- *(views)* report a node's landing from a read taken when the view renders ([#201](https://github.com/nickderobertis/onepipeline/pull/201))

### Fixed

- *(channel)* stop counting a surface whose reader has gone as one waiting for the planner ([#199](https://github.com/nickderobertis/onepipeline/pull/199))
...
- *(driver)* keep an observer watching a live run and record why one ended ([#197](https://github.com/nickderobertis/onepipeline/pull/197))

## [0.21.0](https://github.com/nickderobertis/onepipeline/compare/v0.20.0...v0.21.0) - 2026-09-03

### Added

- *(watch)* give a supervisor one bounded, resumable wait with a status to branch on ([#194](https://github.com/nickderobertis/onepipeline/pull/194))
