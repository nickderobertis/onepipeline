...
Entries **10–22, 33, 35–40, 46–73, 76, 80 and 83 are open**, except **52**, which entry 60
...
rest — 36 to 40, 46 to 73, 80 and 83 — are for the planner who owns the contract, and
...
- **`views::NodeLanding`**, one node's landing **inputs** — the landing its
  ...
  names it (entry 83) — because a version-6 document carries no answer to where
...
## 83. What agents ran under a run was knowable only on a host that configured oneharness exactly as this one did — OPEN
