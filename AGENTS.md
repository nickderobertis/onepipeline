...
A recipe that needs the network, a second toolchain, or a credential sits outside
both, says why in its justfile comment, and runs in CI as its own job, through
the recipe rather than around it.
